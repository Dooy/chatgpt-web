...
import type { ChatGPTAPIOptions, ChatMessage, SendMessageOptions } from 'chatgpt-dooy'
import { ChatGPTAPI, ChatGPTUnofficialProxyAPI } from 'chatgpt-dooy'
...
(async () => {
  // More Info: https://github.com/transitive-bullshit/chatgpt-api
	if (isNotEmptyString(  process.env.OPENAI_MAX_TOKEN  )) max_tokens=parseInt( process.env.OPENAI_MAX_TOKEN );
